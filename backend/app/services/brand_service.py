...
class BrandService:
    async def list(self, user_id: uuid.UUID) -> list[BrandContext]:
    ...
    async def create(self, user_id: uuid.UUID, name: str, website_url: str | None = None, colors: list[str] | None = None) -> BrandContext:
        async with async_session_factory() as db:
